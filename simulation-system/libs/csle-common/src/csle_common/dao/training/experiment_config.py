...
from csle_common.dao.poisoning.env_poisoning import EnvPoisoning, MetaAgent
...
class ExperimentConfig(JSONSerializable):
    ...
    def __init__(self, output_dir: str, title: str, random_seeds: List[int], agent_type: AgentType,
                 ...
                 br_log_every: int = 10, poisoning_strategie: EnvPoisoning = None, meta_agent: MetaAgent = None):
        """
        Initializes the DTO
        ...
        self.poisoning_strategie = poisoning_strategie
